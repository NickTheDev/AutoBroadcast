...
/**
 * Adapted resource for version independent sounds from @Nikl.
...
public enum SoundMatcher {
    ...
    /**
     * Declares the sound with the different version names.
     *
     * @param versions Versions of the sound.
     */
    SoundMatcher(String... versions) {
