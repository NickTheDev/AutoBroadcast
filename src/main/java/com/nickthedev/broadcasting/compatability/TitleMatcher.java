 ...
 */
package com.nickthedev.broadcasting.compatability;
...
/**
 * Cross version title sending resource adapted from the Spigot Wiki.
 *
 * @author NickTheDev
 * @since 3.0
 */
    ...
    public static void send(Player player, String title, String subtitle, int fadeInTime, int showTime, int fadeOutTime) {
        try {
            Object chatTitle = getNMSClass("IChatBaseComponent").getDeclaredClasses()[0].getMethod("a", String.class)
                    .invoke(null, "{\"text\": \"" + Chat.color(title) + "\"}");
            ...
            Object chatsTitle = getNMSClass("IChatBaseComponent").getDeclaredClasses()[0].getMethod("a", String.class)
                    .invoke(null, "{\"text\": \"" + Chat.color(subtitle) + "\"}");
            ...
            Broadcasting.get().getLogger().severe("Titles are unsupported with this server version and cannot be sent.");
        }
    }
